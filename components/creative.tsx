      ...
      <motion.div
        ...
        animate={{
          background: [
            ...
            "radial-gradient(circle at 30% 70%, rgba(0, 194, 199, 0.5) 0%, rgba(81, 45, 168, 0.5) 50%, rgba(0, 0, 0, 0) 100%)",
        ...
        <div className="flex h-full flex-col border-r">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold">Noble Forge</h2>
      ...
      >
        <header className="sticky top-0 z-10 flex h-16 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur">
          ...
          <div className="flex flex-1 items-center justify-between">
            <h1 className="text-xl font-semibold">Noble Forge Creative</h1>
            <div className="flex items-center gap-3">
              <TooltipProvider>
                <Tooltip>
                ...
                <TabsContent value="home" className="space-y-8 mt-0">
                  <section>
                    <motion.div
                      ...
                      className="overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 p-8 text-white"
                    >
                      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-4">
                          ...
                          <h2 className="text-3xl font-bold">
                            Welcome to Noble Forge Creative Suite
                          </h2>
                  ...
                  <section>
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <Button className="w-fit rounded-2xl bg-white text-cyan-700 hover:bg-white/90">
                          <Download className="mr-2 h-4 w-4" />
                          Install Desktop App
                        </Button>
                      </div>
