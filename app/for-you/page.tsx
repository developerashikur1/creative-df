  ...
  return (
    <main className="min-h-screen bg-[#0A0A0B] text-[#FAFBFF]">
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/For-Entrepreneurs-V1.jpg"
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/For-Parents-V1.jpg"
                alt="Parents visual"
                className="w-full h-full object-cover"
              />
            </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/For-Executives-V2.jpg"
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/For-Students-V2.jpg"
                alt="Students visual"
                className="w-full h-full object-cover"
              />
            </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/Shared-Intelligence.jpg"
      ...
      <section className="py-32 px-6 flex justify-center items-center min-h-screen relative overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <img
            src="/images/images/Learns-you-not-the-other-way-around.jpg"
            alt="Neural Orb Background"
            className="w-full h-full object-cover"
          />
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12 text-xs">
            <div>
              ...
              <ul className="space-y-2 text-[#FAFBFF]/50">
                <li>
                  <Link href="/how-it-works" className="hover:text-[#FAFBFF]">
                    How It Works
                  </Link>
                </li>
                <li>
                  <Link href="/integrations" className="hover:text-[#FAFBFF]">
                    Integrations
                  </Link>
                </li>
                <li>
                  <Link href="/pricing" className="hover:text-[#FAFBFF]">
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link href="/download" className="hover:text-[#FAFBFF]">
                    Download
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#FAFBFF]/50">
                <li>
                  <Link href="/for-you" className="hover:text-[#FAFBFF]">
                    Entrepreneurs
                  </Link>
                </li>
                <li>
