...
// import atHumanImg from "../../public/images/images/Automation_that_feels_human.jpg";
// import heroBg from "../../public/images/images/Everything,_finally_in_sync_V1.jpg";
// import connectImg from "../../public/images/images/One_connection._Endless_flow.jpg";
// import privateImg from "../../public/images/images/Private_value.jpg";
// import togetherImg from "../../public/images/images/Together_Effortlessly_V2.jpg";
// import worksImg from "../../public/images/images/Works_everywhere_you_do.jpg";
...
export default function IntegrationsPage() {
  const integrationCards = [
    ...
    },
    {
      ...
      icon: "/images/logos/wyze.png",
    },
    {
      name: "Notion",
      category: "Projects & Notes",
      icon: "/images/logos/notion-logo.png",
    },
    {
      name: "Google Drive",
      category: "Files & Sharing",
      icon: "/images/logos/google_drive.png",
    },
    {
      name: "HomeKit",
      category: "Smart Environment",
      icon: "/images/logos/homekitetmoi.png",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0A0A0B] to-[#111217]">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-24 px-6 overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <img
            src="/images/images/Everything,_finally_in_sync_V1.jpg"
            alt="Background"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-background via-background/60 to-transparent" />
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/One_connection._Endless_flow.jpg"
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto space-y-16">
          <motion.div
            ...
            className="text-center space-y-6"
          >
            <h2 className="text-4xl md:text-6xl font-bold text-[#FAFBFF]">
              Built for your favorites.
            </h2>
            <p className="text-[#FAFBFF]/70 text-lg max-w-3xl mx-auto">
              Orion works with the tools you already use — no new habits
              needed. It simply fits in and keeps everything in harmony.
            </p>
          </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-[1200px] w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/images/Automation_that_feels_human.jpg"
            ...
            >
              ...
              <p className="text-[#FAFBFF]/70 text-lg">
                Orion doesn't just connect APIs — it understands intent. From
                rescheduling meetings to dimming lights, every action feels
                natural and timely.
              </p>
      ...
      <section className="py-32 px-6 flex justify-center items-center min-h-screen relative overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <img
            src="/images/images/Works_everywhere_you_do.jpg"
      ...
      <section className="py-32 px-6 bg-[#101214] flex justify-center items-center min-h-screen relative overflow-hidden">
        <div className="max-w-[1200px] w-full mx-auto relative">
          ...
          >
            ...
            <p className="text-[#FAFBFF]/70 text-lg max-w-2xl mx-auto">
              Start your free beta and let Orion link your world — safely,
              quietly, intelligently.
            </p>
        ...
        <div className="max-w-[1200px] w-full mx-auto px-6 py-12">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12 text-xs">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#FAFBFF]/70">
                <li>
                  <Link href="/help" className="hover:text-[#FAFBFF]">
                    Support
                  </Link>
                </li>
                <li>
                  <Link href="/help/status" className="hover:text-[#FAFBFF]">
                    System Status
                  </Link>
                </li>
                <li>
                  <Link href="/press" className="hover:text-[#FAFBFF]">
                    Press
                  </Link>
                </li>
                <li>
                  <Link href="/changelog" className="hover:text-[#FAFBFF]">
                    Changelog
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#FAFBFF]/70">
                <li>
                  <Link href="/about" className="hover:text-[#FAFBFF]">
                    About Noble Forge
                  </Link>
                </li>
                <li>
                  <Link href="/careers" className="hover:text-[#FAFBFF]">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="hover:text-[#FAFBFF]">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#FAFBFF]/70">
                <li>
                  <Link href="/privacy" className="hover:text-[#FAFBFF]">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/legal/terms" className="hover:text-[#FAFBFF]">
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link href="/legal/dpa" className="hover:text-[#FAFBFF]">
                    DPA
                  </Link>
                </li>
                <li>
                  <Link href="/legal/cookies" className="hover:text-[#FAFBFF]">
                    Cookies
                  </Link>
                </li>
              </ul>
