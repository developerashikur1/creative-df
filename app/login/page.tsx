...
import { ArrowLeft, Lock, Mail, CircleDotIcon } from "lucide-react"
      ...
      >
        ...
        <Card className="p-8 rounded-3xl border border-border bg-card shadow-lg">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">Sign in to access your admin panel</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              type="button"
              variant="outline"
            //   className="h-12 border-border bg-muted hover:bg-muted/80 text-foreground rounded-2xl"
            className="rounded-full !border !border-gray-200 dark:!text-white hover:bg-white/10 px-8 h-12 text-sm font-medium bg-transparent backdrop-blur-sm cursor-pointer"
            >
